...
@Component({
  selector: 'app-tout-dmd-rdn',
  templateUrl: './tout-dmd-rdn.component.html',
  styleUrls: ['./tout-dmd-rdn.component.css']
})
export class ToutDmdRdnComponent implements OnInit {
